...
function chaiTapriRevenue(customers) {
  let chaiTotalRevenue = {
    totalChai: 0,
    totalRevenue: 0,
  };
  ...
  if (
    ...
    return chaiTotalRevenue;

  let cuttingChaiRevenue = 0;
  let adrakChaiRevenue = 0;
  for (let i = 1; i <= customers; i++) {
    chaiTotalRevenue.totalChai = i;
    if (i % 3 !== 0) {
      cuttingChaiRevenue += 10;
    } else {
      adrakChaiRevenue += 15;
    }
  }
  chaiTotalRevenue.totalRevenue = cuttingChaiRevenue + adrakChaiRevenue;

  return chaiTotalRevenue;
}

console.log(chaiTapriRevenue(6));
console.log(chaiTapriRevenue(0));
console.log(chaiTapriRevenue(20));
