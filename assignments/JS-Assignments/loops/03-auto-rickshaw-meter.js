...
function calculateAutoFare(distance, waitingMinutes = 0) {
  if (
    distance <= 0 ||
    waitingMinutes < 0 ||
  ...
  while (dist <= distance) {
    ...
    if (wait <= waitingMinutes) totalFare += 5;
    wait++;
    dist++;
  }
  return totalFare;
...
console.log(calculateAutoFare(3));
console.log(calculateAutoFare(7, 4));
console.log(calculateAutoFare(0.5));
console.log(calculateAutoFare(-2));
