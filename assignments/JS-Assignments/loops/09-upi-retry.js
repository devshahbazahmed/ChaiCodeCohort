...
function upiRetry(outcomes) {
  ...
  do {
    ...
    if (outcomes[index] === "fail") {
      success = false;
      if (attempts === 1) totalWaitTime += 1;
      else if (attempts === 2) totalWaitTime += 2;
      else if (attempts === 3) totalWaitTime += 4;
      else if (attempts === 4) totalWaitTime += 8;
      else if (attempts === 5) {
        totalWaitTime = 15;
        success = false;
        break;
    ...
    index++;
  } while (attempts < outcomes.length);
