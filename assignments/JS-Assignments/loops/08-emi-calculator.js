...
function emiCalculator(principal, monthlyRate, emi) {
  let months = 0;
  let totalPaid = 0;
...
console.log(emiCalculator(10000, 0.01, 2000));
console.log(emiCalculator(10000, 0.05, 400));
console.log(emiCalculator(20000, 0.02, 3000));
console.log(emiCalculator(1000, 0.01, 600));
