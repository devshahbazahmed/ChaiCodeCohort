 ...
 *   // => "voted!"
 */
function createElection(candidates) {
...
function createVoteValidator(rules) {
...
function countVotesInRegions(regionTree) {
...
function tallyPure(currentTally, candidateId) {
  const newTally = {};
