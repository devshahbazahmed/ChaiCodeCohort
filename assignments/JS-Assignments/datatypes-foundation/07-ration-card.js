 ...
 */
function getFamilyNames(registry) {
  if (
...
function getAllFamilies(registry) {
  if (
    typeof registry !== "object" ||
    registry === null ||
    Array.isArray(registry)
...
function getRationCardEntries(registry) {
  if (
    typeof registry !== "object" ||
    registry === null ||
    Array.isArray(registry)
...
function hasRationCard(registry, cardId) {
  if (
    typeof registry !== "object" ||
...
function removeRationCard(registry, cardId) {
  if (
    typeof registry !== "object" ||
    typeof cardId !== "string" ||
    registry === null ||
