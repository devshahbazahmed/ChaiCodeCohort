    ...
    <main className="min-h-screen bg-black text-white flex items-center justify-center px-4">
      <div className="w-full max-w-md space-y-6 rounded-2xl border border-white/10 bg-white/5 p-8 text-center">
        ...
        <div className="flex gap-3 justify-center">
          {user?.id ? (
            <Button onClick={() => router.push("/dashboard/forms")} className="bg-white text-black">
              Dashboard
            </Button>
          ) : (
            <>
              <Button onClick={() => router.push("/signin")} className="bg-white text-black">
                Signin
              </Button>
              <Button onClick={() => router.push("/signup")} className="bg-white text-black">
                Signup
              </Button>
            </>
          )}
